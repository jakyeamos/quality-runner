...
The first paused-wave sample is closed. All five repo threads reported terminal
outcomes to the controller before this ledger was updated.

Observed classifications:

- `broad-repo-debt`: `Dsci-proj`, `Bballedu`, `Fantasy`
- `mixed-blocker`: `BBDSE`, `EliHealth`
...
| 3 | Book | `/Users/jakyeamos/projects/Book` | 22 | 4 | `/Users/jakyeamos/projects/Book/.quality-runner/runs/parallel-20260702T200935Z-Book` | exact-project | triage-running | `019f257a-efc4-7753-8982-69f7dec38242` | triage running |  |  | Triage sample branch `qr/triage-parallel-20260702T200935Z`; launched after QR product fixes in `91b1ceb`. |
| 3 | dispatches-from-cyberspace | `/Users/jakyeamos/projects/dispatches-from-cyberspace` | 22 | 2 | `/Users/jakyeamos/projects/dispatches-from-cyberspace/.quality-runner/runs/parallel-20260702T200935Z-dispatches-from-cyberspace` | parent-project | triage-running | `019f257a-f6c5-7861-b89b-f6498d9a0278` | triage running |  |  | Triage sample branch `qr/triage-parallel-20260702T200935Z`; launched after QR product fixes in `91b1ceb`. |
| 3 | remodelvision | `/Users/jakyeamos/projects/remodelvision` | 22 | 2 | `/Users/jakyeamos/projects/remodelvision/.quality-runner/runs/parallel-20260702T200935Z-remodelvision` | exact-project | triage-running | `019f257b-026f-7c71-835f-f54516b69f79` | triage running |  |  | Triage sample branch `qr/triage-parallel-20260702T200935Z`; launched after QR product fixes in `91b1ceb`. |
| 3 | portfolio | `/Users/jakyeamos/projects/portfolio` | 20 | 2 | `/Users/jakyeamos/projects/portfolio/.quality-runner/runs/parallel-20260702T200935Z-portfolio` | exact-project | triage-running | `019f257b-11a2-7411-8101-c3a992165b3c` | triage running |  |  | Triage sample branch `qr/triage-parallel-20260702T200935Z`; launched after QR product fixes in `91b1ceb`. |
| 3 | video-pipeline | `/Users/jakyeamos/projects/video-pipeline` | 20 | 4 | `/Users/jakyeamos/projects/video-pipeline/.quality-runner/runs/parallel-20260702T200935Z-video-pipeline` | parent-project | triage-running | `019f257b-1afd-7481-bbeb-66bbeb00b6d8` | triage running |  |  | Triage sample branch `qr/triage-parallel-20260702T200935Z`; launched after QR product fixes in `91b1ceb`. |
