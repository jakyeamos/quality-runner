...
SelfUpdatePayload = dict[str, object]
...
def update_command_payload(source: str | None = None) -> SelfUpdatePayload:
...
def _editable_source() -> Path | None:
    ...
    try:
        ...
        return None
    if not editable or parsed.scheme != "file" or not parsed.path:
        return None
