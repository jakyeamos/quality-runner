...
from quality_runner.branch_diff import refresh_scope_payload
...
from quality_runner.refresh_payload import public_timeout_contract
...
def run_refresh_payload(
    *,
    ...
    return {
        ...
        "run_id_prefix": run_id_prefix,
        "timeout_contract": public_timeout_contract(timeout_contract),
        "phase_timings": phase_timings,
        "runs": {
        ...
        "summary": summary,
        **refresh_scope_payload(focus_paths, scope_metadata),
    }
