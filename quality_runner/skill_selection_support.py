...
def diagnostic_signals(signals: set[str], *, priority: set[str] | None = None) -> list[str]:
...
def global_warning(path: object, message: str) -> dict[str, str]:
    return {
...
_diagnostic_signals = diagnostic_signals
_global_warning = global_warning
